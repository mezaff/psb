...
<head>
    ...
    <title>Verifikasi | PSB Pondok Ngujur</title>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="card">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="card-header fw-bold">MANAJEMEN VERIFIKASI <span><a href="export" class="btn btn-success">Export Ke Exel</a></span></h3>
                                ...
                                <table class="table table-hover table-bordered">
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        ...
                                        while ($data = mysqli_fetch_array($sql)) {
                                            ...
                                            echo "<td class='text-center'>" . $data['nisn'] . "</td>";
                                            ...
                                            $nilai = $data['status'];
                                            if ($nilai > 1) {
                                                echo "<a class='btn btn-danger' href='batalkan?id=" . $data['id'] . "' role='button' >Batalkan  </a>";
                                            } else {
                                                echo "<a class='btn btn-primary' href='verifikasi?id=" . $data['id'] . "' role='button' >Verifikasi  </a>";
                                            }
                                            echo "</td>";
                                            echo "</tr>";
                                        }
