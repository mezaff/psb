                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-fluid flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            ...
                            $data = mysqli_fetch_array($sql); // Ambil data
                            ?>

                            <form method="post" action="proses?id=<?php echo $id; ?>" enctype="multipart/form-data" class="w-100">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="card">
                                            <h3 class="card-header fw-bold">PENGATURAN LEMBAGA</h3>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="nama">Nama Lembaga</label>
                                                            <input type="text" name="nama" class="form-control" value="<?php echo htmlspecialchars($data['nama']); ?>" autocomplete="off" required="">
                                                        </div>
                                                        <div class="mb-3">
                                                        ...
                                                        <div class="mb-3">
                                                            <label class="form-label" for="lokasi">Alamat</label>
                                                            <input type="text" name="lokasi" class="form-control" value="<?php echo $data['lokasi']; ?>" autocomplete="off" required="">
                                                        </div>
                                                        <div class="mb-3">
                                                            <label class="form-label" for="email">Email</label>
                                                            <input type="text" name="email" class="form-control" value="<?php echo $data['email']; ?>" autocomplete="off" required="">
                                                        </div>
                                                        <div class="mb-3">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            <label class="form-label" for="jenispd">Username</label>
