...
<body>
                        ...
                        <div class="col-12 col-md-6 order-md-2 order-first">
                            <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manajemen Verivikasi</li>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <br>
                            <br>
                            <a href="export2.php" class="btn btn-primary">Export File To Excel</a>
                        </div>
                        <div class="card-body">
                            <table class="table table-striped" id="table1">
                                <thead>
                                    <tr>
										...
										<th>Alamat</th>
                                        <th>Asal Sekolah</th>
                                        <th>Nomor Telp Siswa</th>
										<th>Nomor Telp Ortu/Wali</th>
                                        <th> Hapus</th>
                                    </tr>
                                </thead>
                                <tbody>
 ...
 echo "<td><a class='btn btn-warning' href='hapus.php?id=".$data['id']."' role='button' >Hapus  </a></td>"; 
