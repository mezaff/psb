...
<head>
    ...
    <title>Pendaftaran Gagal | PSB Pondok Ngujur</title>
...
<body>
    ...
    <div class="container-xxl container-p-y">
        <div class="misc-wrapper">
            ...
            <h4 class="mb-2 mx-2">Akses Dilarang! 🔐</h4>
            <p class="mb-6 mx-2">Anda tidak memiliki hak untuk mengakses halaman ini. Kembali ke halaman utama!</p>
            <a href="/santribaru" class="btn btn-primary">Kembali</a>
            <div class="mt-6">
                <img src="assets/sneat/assets/img/illustrations/girl-with-laptop-light.png" alt="page-misc-not-authorized-light" width="500" class="img-fluid" data-app-light-img="illustrations/girl-with-laptop-light.png" data-app-dark-img="illustrations/girl-with-laptop-dark.png" />
            </div>
        </div>
    </div>
    <!-- /Not Authorized -->
