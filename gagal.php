...
<body>
  ...
  <div class="container-xxl container-p-y">
    <div class="misc-wrapper">
      <h2 class="mb-2 mx-2 fw-bold text-danger">PENDAFTARAN GAGAL!</h2>
      <p class="mb-4 mx-2">NISN ANDA SUDAH TERDAFTAR DI SISTEM KAMI, PASTIKAN NISN YANG ANDA MASUKKAN SUDAH BENAR, <br> ATAU SILAHKAN CEK DATA ANDA MELALUI TOMBOL DIBAWAH</p>
      <a href="cekdata" class="btn btn-primary">CEK DATA</a>
      <div class="mt-4">
        <img
